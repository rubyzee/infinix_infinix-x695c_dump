...
#BSP: modify 1st-lcm_drv XLJWHBWS-1 by baofu.zhang 20201113 start
BOOT_LOGO = fhdplus2460
#BSP: modify 1st-lcm_drv XLJWHBWS-1 by baofu.zhang 20201113 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP: add project macro XLJWHBWS-3492 by wang.qin 20210312 start
CUSTOM_BUILD_VERNO = CY-X695C-H854-J
#BSP: add project macro XLJWHBWS-3492 by wang.qin 20210312 end
...
CUSTOM_HAL_IMGSENSOR = s5kgw1sd_mipi_raw s5k3p9sp_mipi_raw hi1631q_mipi_raw gc02m1b_mipi_raw gc8034main_mipi_raw ov02b1b_mipi_raw pblcs5kgw1sd_mipi_raw pblcs5k3p9sp_mipi_raw pblchi1631q_mipi_raw pblcgc02m1b_mipi_raw pblcgc8034main_mipi_raw pblcov02b1b_mipi_raw
CUSTOM_HAL_SUB_IMGSENSOR = s5k3p9sp_mipi_raw hi1631q_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = s5kgw1sd_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = gc02m1b_mipi_raw
CUSTOM_TRAN_HAL_MAIN3_IMGSENSOR = gc8034main_mipi_raw
CUSTOM_TRAN_HAL_MAIN4_IMGSENSOR = ov02b1b_mipi_raw
#ITD: Modify Camera By ISP Team End
#BSP: add XLJWHBWS-4 by zhigang.yang for 20201118 start
TRAN_SINGLE_ALS_CALI = yes
CUSTOM_HAL_MSENSORLIB = akm09918_x695
#BSP: add XLJWHBWS-4 by zhigang.yang for 20201118 end
...
#ITD: Modify Camera By ISP Team Start
CUSTOM_KERNEL_IMGSENSOR = s5kgw1sd_mipi_raw s5k3p9sp_mipi_raw hi1631q_mipi_raw gc02m1b_mipi_raw gc8034main_mipi_raw ov02b1b_mipi_raw
#ITD: Modify Camera By ISP Team End
...
#ITD: Modify Camera By ISP Team Start
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k3p9sp_mipi_raw hi1631q_mipi_raw
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5kgw1sd_mipi_raw
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc02m1b_mipi_raw
CUSTOM_TRAN_KERNEL_MAIN3_IMGSENSOR = gc8034main_mipi_raw
CUSTOM_TRAN_KERNEL_MAIN4_IMGSENSOR = ov02b1b_mipi_raw
...
#BSP: add XLBJHLJL-28 by zhigang.yang for 20201204 start
CUSTOM_KERNEL_SIGNIFICANT_MOTION_SENSOR = yes
#BSP: add XLBJHLJL-28 by zhigang.yang for 20201204 end
#BSP: add XLJWHBWS-4 by zhigang.yang for 20201118 end
...
#TSD: modify CMSFTASK-11 by baoxin.he 20201119 start
CUSTOM_MODEM = x695_h854_d1
#TSD: modify CMSFTASK-11 by baoxin.he 20201119 end
...
MTK_ATF_SUPPORT=yes
MTK_AUDIO = yes
# BSP:modify audio bring up XLJWHBWS-2 shuanglei.wang 20201117 start
#MTK_AUDIODSP_SUPPORT = yes
# BSP:modify audio bring up XLJWHBWS-2 shuanglei.wang 20201117 end
...
#ITD:modify by hao.ding 20201113 start
MTK_CAM_HDR_SUPPORT = no
#ITD:modify by hao.ding 20201113 end
...
#ITD:modify by hao.ding 20201127 start
MTK_CAM_ZSDHDR_SUPPORT = no
#ITD:modify by hao.ding 20201127 end
...
MTK_FM_SUPPORT = yes
#TSD:add CMSFTASK-10 by zhouxiang.cao 20201118 start
MTK_FM_GPIO_FUNC = yes
#TSD:add CMSFTASK-10 by zhouxiang.cao 20201118 end
...
#BSP:modify CEJXLBQ-18 by shuanglei.wang 20200407 start
MTK_HIFIAUDIO_SUPPORT = no
#BSP:modify CEJXLBQ-18 by shuanglei.wang 20200407 end
...
MTK_IPV6_VZW = no
#TCD:close XLJWHBWS-1320 by lichen.yu 20201230 start
MTK_IRTX_PWM_SUPPORT = no
#TCD:close XLJWHBWS-1320 by lichen.yu 20201230 end
MTK_IRTX_SUPPORT = no
MTK_ISP_SUPPORT_COLOR_SPACE = 0
#BSP:modify jeita function CEJXLBQ-29 by yongxian.wang 20201116 start
MTK_JEITA_STANDARD_SUPPORT = yes
#BSP:modify jeita function CEJXLBQ-29 by yongxian.wang 20201116 end
MTK_K64_SUPPORT=yes
...
#TSD: add NFC support TSDT-151 by yunfei.wu 20201210 start
NFC_CHIP_SUPPORT = yes
MTK_NFC_ADDON_SUPPORT = yes
MTK_NFC_GSMA_SUPPORT = no
MTK_NFC_SE_NUM = 7
#TSD: add NFC support TSDT-151 by yunfei.wu 20201210 end
...
#TSD: modify CMSFTASK-11 by baoxin.he 20201119 end
#BSP:add for charger pump CLBLEPUB-517 by yongxian.wang 20201116 start
MTK_PUMP_EXPRESS_PLUS_20_SUPPORT = yes
MTK_PUMP_EXPRESS_PLUS_30_SUPPORT = no
MTK_PUMP_EXPRESS_PLUS_SUPPORT = yes
#BSP:add for charger pump CLBLEPUB-517 by yongxian.wang 20201116 end
...
#NFBD:add nfc TSDT-151 add by yunfei.wu 20201209 start
ST_NFC_CHIP_VERSION = ST21NFCD
#NFBD:add nfc TSDT-151 add by yunfei.wu 20201209 end
...
#BSP: modify XLJWHBWS-1 by baofu.zhang 20201216 start
MTK_HIGH_FRAME_RATE = yes
#BSP: modify XLJWHBWS-1 by baofu.zhang 20201216 end
...
MTK_TOUCHPANEL_KO =
#BSP: add project clone format by wanghanfeng 20201030 start
...
#BSP: add project clone format by wanghanfeng 20201030 end
#SDD: add project sw version by jiangping.guo 20201030 start
MTK_BUILD_VERNO=X695C-H854JK-R-GL-211217V320
TRAN_FINGERPRINT_BUILD_VERNO=211217V320
#SDD: add project sw version by jiangping.guo 20201030 end
#BSP: add project macro by wanghanfeng 20201030 start
CUSTOM_TRAN_PROJECT=tran_x695
CUSTOM_TRAN_BOM=tran_x695_d1
#BSP: add project macro by wanghanfeng 20201030 end
